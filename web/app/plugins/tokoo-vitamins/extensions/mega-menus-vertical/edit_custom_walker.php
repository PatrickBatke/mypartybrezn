		...
		<li id="menu-item-<?php echo esc_attr( $item_id ); ?>" class="<?php echo implode(' ', $classes ); ?>">
			...
			<div class="menu-item-settings" id="menu-item-settings-<?php echo esc_attr( $item_id ); ?>">
				...
				<div class="mega-menu-options">
					...
					<p class="field-mm-pb description description-wide">
						<label for="edit-menu-item-mm_pb-<?php echo esc_attr( $item_id ); ?>">
						<?php _e( 'Padding Bottom', 'tokoo-vitamins' ); ?><br />
						<input type="text" id="edit-menu-item-mm_pb-<?php echo esc_attr( $item_id ); ?>" class="widefat edit-menu-item-custom mega-menu-pb" name="menu-item-mm_pb[<?php echo esc_attr( $item_id ); ?>]" value="<?php echo esc_attr( $item->mm_pb ); ?>" placeholder="Padding bottom"/>
					</p>

					<p class="field-mm-pr description description-wide">
						<label for="edit-menu-item-mm_pr-<?php echo esc_attr( $item_id ); ?>">
						<?php _e( 'Padding Right', 'tokoo-vitamins' ); ?><br />
						<input type="text" id="edit-menu-item-mm_pr-<?php echo esc_attr( $item_id ); ?>" class="widefat edit-menu-item-custom mega-menu-pr" name="menu-item-mm_pr[<?php echo esc_attr( $item_id ); ?>]" value="<?php echo esc_attr( $item->mm_pr ); ?>" placeholder="Padding bottom"/>
					</p>
