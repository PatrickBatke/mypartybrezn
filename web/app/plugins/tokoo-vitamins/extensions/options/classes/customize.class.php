...
class CSFramework_Customize {
	...
	public function __construct() {
		...
		$this->options = apply_filters( 'tokoo_customize_options', $options );
	...
	public function customize_register( $wp_customize ) {
		...
		require_once CS_OPTION_DIR . 'functions/customize.php';
