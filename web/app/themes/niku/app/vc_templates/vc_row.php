...
$fixBg 		= (!empty($fixed_background)) ? " fixed-background " : "";
...
$css_classes = array(
	...
	'wpb_row', //deprecated
	'vc_row-fluid',
	($bg_overlay) ? "has-overlay" : "",
	($equalize_column_height) ? "equalize-column-height" : "",
	$bg_position,
	$fixBg,
	$el_class,
...
$output .= '<span class="tokoo-row-overlay" style="background-color:'. $bg_overlay .'"></span>';
