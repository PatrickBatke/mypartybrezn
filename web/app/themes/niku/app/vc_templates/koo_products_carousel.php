...
$woo_carousels 	= new WP_Query( apply_filters( 'woocommerce_shortcode_products_query', $query_args ) );

echo '<div class="woocommerce columns-' . $columns . '">';

	if ( $woo_carousels->have_posts() ) : ?>

		<div class="products products-carousel <?php echo esc_attr( $product_image_style ); ?>" data-items="<?php echo esc_attr( $columns ); ?>">

		<?php while ( $woo_carousels->have_posts() ) : $woo_carousels->the_post(); ?>
