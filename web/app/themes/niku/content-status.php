...
$meta     = get_post_meta( get_the_ID(), '_embedded_link', true );
$embedded = ! empty( $meta['embedded_link'] ) ? $meta['embedded_link'] : '';
?>
	...
	<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="inner-post">
			...
			<?php
				...
				$background = ( ! empty( $image_url ) ) ? ' data-bg-image="' . esc_url( $image_url ) . '"' :
					' data-trianglify';
			?>
			<figure class="status-media" <?php printf( $background ); ?>>
