...
/**
 * The Template for displaying content of post format video
 *
 * @author 		tokoo
 * @version     2.0
 */
...
<?php if ( is_singular( get_post_type() ) ) { ?>
	...
	<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="inner-post">
			...
			<?php $video = tokoo_media_grabber( array( 'type' => 'video', 'split_media' => true ) ); ?>
			<?php if ( ! empty ( $video ) ) : ?>
				<figure class="featured-image media-wrap">
					<?php printf( $video ); ?>
				</figure>
			<?php endif;  ?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<div class="inner-post">
			...
			<?php if ( $tokoo_blog_display_type == 'masonry' ) : ?>
				...
				<?php $video = tokoo_media_grabber( array( 'type' => 'video', 'split_media' => true ) ); ?>
				<?php if ( ! empty ( $video ) ) : ?>
					<figure class="featured-image media-wrap video-wrap">
						<?php printf( $video ); ?>
					</figure>
				<?php endif; ?>
