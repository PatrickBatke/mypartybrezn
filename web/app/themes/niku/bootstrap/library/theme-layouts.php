 ...
 * @return void
 */
if ( ! function_exists( 'theme_layouts_register_meta' ) ) {
 ...
 */
if ( ! function_exists( 'theme_layouts_sanitize_meta' ) ) {
 ...
 * @return void
 */
if ( ! function_exists( 'theme_layouts_add_post_type_support' ) ) {
 ...
 * @return void
 */
if ( ! function_exists( 'theme_layouts_remove_post_type_support' ) ) {
 ...
 */
if ( ! function_exists( 'theme_layouts_get_layouts' ) ) {
 ...
 */
if ( ! function_exists( 'theme_layouts_get_args' ) ) {
 ...
 * @return string
 */
if ( ! function_exists( 'theme_layouts_filter_layout' ) ) {
 ...
 */
if ( ! function_exists( 'get_post_layout' ) ) {
 ...
 */
if ( ! function_exists( 'set_post_layout' ) ) {
 ...
 */
if ( ! function_exists( 'delete_post_layout' ) ) {
 ...
 */
if ( ! function_exists( 'has_post_layout' ) ) {
 ...
 * @return bool            True on successful update, false on failure.
 */
if ( ! function_exists( 'set_user_layout' ) ) {
 ...
 * @return bool            True on successful delete, false on failure.
 */
if ( ! function_exists( 'delete_user_layout' ) ) {
 ...
 */
if ( ! function_exists( 'has_user_layout' ) ) {
 ...
 */
if ( ! function_exists( 'theme_layouts_body_class' ) ) {
 ...
 * @return string
 */
if ( ! function_exists( 'theme_layouts_get_string' ) ) {
 ...
 * @return void
 */
if ( ! function_exists( 'theme_layouts_admin_setup' ) ) {
 ...
 * @return void
 */
if ( ! function_exists( 'theme_layouts_load_meta_boxes' ) ) {
 ...
 * @return void
 */
if ( ! function_exists( 'theme_layouts_add_meta_boxes' ) ) {
	function theme_layouts_add_meta_boxes( $post_type, $post ) {
		...
		if ( ( post_type_supports( $post_type, 'theme-layouts' ) ) && ( current_user_can( 'edit_post_meta', $post->ID ) || current_user_can( 'add_post_meta', $post->ID ) || current_user_can( 'delete_post_meta', $post->ID ) ) )
			add_meta_box( 'theme-layouts-post-meta-box', esc_html__( 'Layout', 'tokoo' ), 'theme_layouts_post_meta_box', $post_type, 'side', 'default' );
	}
}
 ...
 * @return void
 */
if ( ! function_exists( 'theme_layouts_post_meta_box' ) ) {
 ...
 * @return void|int
 */
if ( ! function_exists( 'theme_layouts_save_post' ) ) {
 ...
 * @return array  $fields
 */
if ( ! function_exists( 'theme_layouts_attachment_fields_to_edit' ) ) {
 ...
 * @return array  $post
 */
if ( ! function_exists( 'theme_layouts_attachment_fields_to_save' ) ) {
 ...
 */
if ( ! function_exists( 'theme_layouts_get_meta_key' ) ) {
 ...
 */
if ( ! function_exists( 'theme_layouts_customize_register' ) ) {
	function theme_layouts_customize_register( $wp_customize ) {
		...
		if ( true === $args['customize'] ) {
			...
			$wp_customize->add_control(
				...
				array(
					'label'    => esc_html__( 'Global Layout', 'tokoo' ),
					'section'  => 'layout',
 ...
 * @return    void
 */
if ( ! function_exists( 'theme_layouts_customize_preview_script' ) ) {
 ...
 */
if ( ! function_exists( 'post_layouts_get_layout' ) ) {
